...
namespace Base
{
    public partial class ActualizarIndirecto : Form
    {
        Usuario user;
        public ActualizarIndirecto(Usuario user)
        {
            InitializeComponent();
            this.user = user;
        }
        ...
        private void btnSincronizarDatos_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection conector = new SqlConnection(conString))
                {
                    ...
                    string query = @"EXEC InsertarDatosIterativo_DatosIndirectos;";
                    SqlCommand cmd = new SqlCommand(query, conector);
                    cmd.ExecuteNonQuery();
                    conector.Close();
                }
        ...
        private void ActualizarIndirecto_Load(object sender, EventArgs e)
        {
            // Actualizamos las de Datos Indirectos mediante las formulas
