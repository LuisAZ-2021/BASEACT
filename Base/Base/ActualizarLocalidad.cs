...
namespace Base
{
    public partial class ActualizarLocalidad : Form
    {
        Usuario user;
        public ActualizarLocalidad(Usuario user)
        {
            InitializeComponent();
            this.user = user;
        }
        ...
        public void Actualizar()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error botón del Detalle localidad:" + ex.Message);
            }
        }
        private void ActualizarLocalidad_Load(object sender, EventArgs e)
        {
            Actualizar();
        ...
        private void dataGridView1_CellBeginEdit(object sender, DataGridViewCellCancelEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                int cellID = (int)dataGridView1.Rows[e.RowIndex].Cells["CANTIDAD LOCALIDAD"].Value;
                ...
                {
                    editForm = new EditCellForm(valorActual, user, 1);
                }
        ...
        private void btnDescargarExcel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    saveFile.FileName = string.Format("DetalleLocalidad_{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmm"));
