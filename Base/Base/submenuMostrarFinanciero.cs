...
namespace Base
{
    public partial class submenuMostrarFinanciero : Form
    {
        public submenuMostrarFinanciero()
        {
            InitializeComponent();
        }
        ...
        public void MostrarFinanciero()
        {
            ...
            try
            {
                using (SqlConnection conector = new SqlConnection(conString))
                {
                    ...
                    Fi.[AG Y CL (SIN CONEXION - SERVICIO NO MEDIDO)], Fi.[TOTAL TASA BASICA], 
                    Fi.[AGUA (SERVICIO MEDIDO)], 
                    Fi.[AGUA Y CLOACA (SERVICIO MEDIDO)], Fi.[TOTAL SERVICIO MEDIDO], 
                    Fi.[TOTAL GENERAL facturado] ,Fi.[TOTAL NO facturado]
        ...
        private void submenuMostrarFinanciero_Load(object sender, EventArgs e)
        {
            MostrarFinanciero();
